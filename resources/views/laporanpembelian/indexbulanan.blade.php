...
<div class="row">
<h1 align="center">Laporan Bulanan</h1>

<p>Tanggal
  <input type="date" name="tgl" value=""></p>
<a href="/indexbulanan/{date}" class="pull-left btn btn-success" id="cari-laporan-bulanan" style="margin-right: 5px; margin-bottom: 20px">
